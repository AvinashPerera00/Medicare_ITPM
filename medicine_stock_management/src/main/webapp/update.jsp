...
String sql ="select * from mstock where pno="+id;
...
<input type="hidden" name="pno" value="<%=resultSet.getString("pno") %>" class="w3-input">
<input type="text" name="pno" value="<%=resultSet.getString("pno") %>" class="w3-input">
<br>
Product Name:<br>
<input type="text" name="pname" value="<%=resultSet.getString("pname") %>" class="w3-input">
<br>
MFD:<br>
<input type="date" name="mfd" value="<%=resultSet.getString("mfd") %>" class="w3-input">
<br>
EXD:<br>
<input type="date" name="exd" value="<%=resultSet.getString("exd") %>" class="w3-input">
<br>
No of units:<br>
<input type="text" name="units" value="<%=resultSet.getString("units") %>" class="w3-input">
<br>
Price of a unit:<br>
<input type="text" name="unitprice" value="<%=resultSet.getString("unitprice") %>" class="w3-input">
<br>
