<%@ page language="java" contentType="text/html; charset=ISO-8859-1" pageEncoding="ISO-8859-1" %>
    ...
    <body>
            ...
            <div class="row">
                <div class="col-sm-9 col-md-7 col-lg-5 mx-auto ">
                    <div class="card border-0 shadow rounded-3 my-5 ">
                        <div class="card-body p-4 p-sm-5 bgimage rounded border border-primary">
                            ...
                            <form method="post" action="./insert-details.jsp">
                                <div class="form-floating mb-3">
                                    <input type="text" name="uname" id="name" class="form-control" id="name" required>
                                    <label for="floatingname">Enter
                                        Name With Initials of the patient</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" name="unic" id="nic" class="form-control" id="nic" required>
                                    <label for="floatingnic">Enter
                                        Nic</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="text" name="uaddress" id="add" class="form-control" id="address"
                                        required> <label for="floatingaddress">Enter
                                        Address</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input type="email" name="uemail" id="email" class="form-control" id="email"
                                        required> <label for="floatingemail">Enter Email</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <textarea name="utext" id="details" class="form-control" id="text"
                                        required></textarea>
                                ...
                                <div class="d-grid">
                                    <button class="btn btn-primary btn-login  fw-bold" type="submit">Request</button>
                                    <hr class="my-4">
        ...
        <footer class="bg-primary text-center text-white">
            ...
            <div class="text-center text-bold p-3" style="background-color: rgba(0, 0, 0, 0.2);">
